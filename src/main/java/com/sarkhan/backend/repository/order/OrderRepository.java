...
public interface OrderRepository extends JpaRepository<Order, Long> {
    @Query("select sum(o.totalPrice) from Order o where o.seller.id=:sellerId")
    ...
    @Query("select count(o) from Order o where o.seller.id=:sellerId and o.orderStatus=:orderStatus")
    ...
    @Query("select new map(extract(month from o.orderDate) as month,sum(o.totalPrice) as income ) " +
            "from Order o where o.seller.id=:sellerId group by extract(month from o.orderDate) ")
